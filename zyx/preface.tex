...
\begin{titlepage}
 \centering
 {\LARGE \textsc{\myDepartment}}\\[0.8em]
 {\Large \textsc{\myUniversity}}
 \vfill
 \vfill
 {\Large \myThesisType}
 \vfill
...
\begin{center}
 ...
 \begin{spacing}{1.1}
  \Huge \bfseries \myTitle
 \end{spacing}
 \ifthenelse{\equal{\myTitleNative}{}}{}{
  \vspace{2em}
  \begin{spacing}{1.1}
 ...
 \begin{tabularx}{\textwidth}{R{1} L{1}}
...
{\setlength{\parindent}{0cm}%
 \ifthenelse{\equal{\mylanguage}{de}}{%
  \begin{otherlanguage}{ngerman}
   Ich versichere, dass ich diese {\myThesisTypeShort} selbstständig verfasst und nur die angegebenen Quellen und Hilfsmittel verwendet habe.\\[7em]
